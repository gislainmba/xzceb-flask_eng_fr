...
class TestMachineTranslation(unittest.TestCase):
    ...
    def english_to_french(self):
        self.assertEqual(english_to_french(''), 'NULL') # If the input is "Null" the output is "Null"
        self.assertEqual(english_to_french('Hello'), 'Bonjour') # If the input is "Hello" the output is "Bonjour"

    def french_to_english(self):
        self.assertEqual(french_to_english(''), 'NULL') # If the input is "Null" the output is "Null"
